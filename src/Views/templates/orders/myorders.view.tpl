<h2 style="text-align:center; font-family: Arial, sans-serif; color: #333;">Mis Compras</h2>
<table style="width:100%; border-collapse: collapse; font-family: Arial, sans-serif; margin: 0 auto; max-width: 900px;">
  <thead>
